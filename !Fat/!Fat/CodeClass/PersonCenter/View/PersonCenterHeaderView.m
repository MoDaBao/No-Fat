...
#define UserNameWidth 200//用户名标签宽度
...
//        CGFloat userWidth = frame.size.width;
//        
//        self.userNAGView = [[UserNameAndGenderView alloc] initWithFrame:CGRectMake(kScreenWidth * 0.5 - userWidth * 0.5 + 12, headY + kHeadImageHeight, userWidth, UserNameHeight)];
//        self.userNAGView.usernameLabel.textColor = [UIColor whiteColor];
//        self.userNAGView.usernameLabel.font = [UIFont boldSystemFontOfSize:17];
//        self.userNAGView.usernameLabel.textAlignment = NSTextAlignmentCenter;
//        [userView addSubview:self.userNAGView];
